pub(crate) const H128: [u32; 4] = [0x6745_2301, 0xEFCD_AB89, 0x98BA_DCFE, 0x1032_5476];
pub(crate) const H160: [u32; 5] = [
    0x6745_2301,
    0xEFCD_AB89,
    0x98BA_DCFE,
    0x1032_5476,
...
pub(crate) const K160_RIGHT: [u32; 5] = [
    0x50A2_8BE6, // (0 <= j <= 15) int(2**30 x cbrt(2))
    0x5C4D_D124, // (16 <= j <= 31) int(2**30 x cbrt(3))
    0x6D70_3EF3, // (32 <= j <= 47) int(2**30 x cbrt(5))
...
#[rustfmt::skip]
pub(crate) const R_LEFT: [usize; 80] = [
...
#[rustfmt::skip]
pub(crate) const R_RIGHT: [usize; 80] = [
...
#[rustfmt::skip]
pub(crate) const S_RIGHT: [u32; 80] = [
