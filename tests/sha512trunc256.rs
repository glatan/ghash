...
fn sha512trunc256_1() {
    ...
    let sha512trunc256 = Sha512Trunc256::hash_to_lowercase("abc".as_bytes());
...
fn sha512trunc256_2() {
    ...
    let sha512trunc256 = Sha512Trunc256::hash_to_lowercase("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu".as_bytes());
    assert_eq!(sha512trunc256, expected);
}
