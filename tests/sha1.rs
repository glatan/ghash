...
#[test]
fn sha1_1() {
    let expected = String::from("a9993e364706816aba3e25717850c26c9cd0d89d");
...
#[test]
fn sha1_2() {
    let expected = String::from("84983e441c3bd26ebaae4aa1f95129e5e54670f1");
...
#[test]
fn sha1_3() {
    let expected = String::from("86f7e437faa5a7fce15d1ddcb9eaeaea377667b8");
...
#[test]
fn sha1_4() {
    let expected = String::from("e0c094e867ef46c350ef54a7f59dd60bed92ae83");
    let sha1 =
