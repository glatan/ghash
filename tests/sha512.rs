...
fn sha512_1() {
    ...
    let sha512 = Sha512::hash_to_lowercase("abc".as_bytes());
...
fn sha512_2() {
    ...
    let sha512 = Sha512::hash_to_lowercase("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu".as_bytes());
    assert_eq!(sha512, expected);
}
