...
fn sha384_1() {
    ...
    let sha384 = Sha384::hash_to_lowercase("abc".as_bytes());
...
fn sha384_2() {
    ...
    let sha384 = Sha384::hash_to_lowercase("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu".as_bytes());
    assert_eq!(sha384, expected);
}
